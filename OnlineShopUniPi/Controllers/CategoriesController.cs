...
namespace OnlineShopUniPi.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var onlineStoreDBContext = _context.Categories.Include(c => c.ParentCategory);
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,Name,ParentCategoryId,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,Name,ParentCategoryId,Description")] Category category)
        {
